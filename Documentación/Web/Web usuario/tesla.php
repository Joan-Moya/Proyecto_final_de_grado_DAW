            ...
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9  col-sm-12 col-12 p-0 m-0"> 
                    <video width="100%" height="240px" loop autoplay muted>
                        <source src="images/teslaVideo.mp4" type="video/mp4" alt="video de muestra">
                    </video>
                </div> 
            </div>
        </div>
   ...
   <!-- BARRA QUE NOS DICE DONDE ESTAMOS -->
    <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Tesla.php" class="text-dark">Tesla</a></li>
            </ol>
    </nav>
        ...
        <div class="container-fluid p-0 ">
            ...
            <div class="dropdown open m-1">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item-text" href="tesla.php?ord=barato">+Barato</a>
                    <a class="dropdown-item" href="tesla.php?ord=caro">+Caro</a>
                  </div>
            </div>
            ...
            <div class="dropdown open m-1">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="tesla.php?cv=120">+120 CV</a>
                    <a class="dropdown-item"  href="tesla.php?cv=150">+150 CV</a>
                    <a class="dropdown-item"  href="tesla.php?cv=200">+200 CV</a>
                  </div>
            </div>
            ...
            <div class="dropdown open m-1">
                  ...
                  <div class="dropdown-menu m-1">
                    <a class="dropdown-item-text" href="tesla.php?km=0">KM 0</a>
                    <a class="dropdown-item" href="tesla.php?km=20000">+ 20.000</a>
                    <a class="dropdown-item" href="tesla.php?km=50000">+ 50.000</a>
                    <a class="dropdown-item" href="tesla.php?km=100000">+ 100.000</a>
                  </div>
            </div>
            ...
            <div class="dropdown open">
                  ...
                  <div class="dropdown-menu m-1">
                    <a class="dropdown-item-text" href="tesla.php?puertas=2">2</a>
                    <a class="dropdown-item" href="tesla.php?puertas=4">4</a>
                    <a class="dropdown-item" href="tesla.php?puertas=>4">+4</a>
                  </div>
            </div>
            ...
            <div class="dropdown open m-1">
                  ...
                  <div class="dropdown-menu m-1">
                    <a class="dropdown-item-text" href="tesla.php?combustible=diesel">Diesel</a>
                    <a class="dropdown-item" href="tesla.php?combustible=gasolina">Gasolina</a>
                    <a class="dropdown-item" href="tesla.php?combustible=electrico">Eléctrico</a>
                    <a class="dropdown-item" href="tesla.php?combustible=hibrido">Hibrido</a>
                  </div>
            </div>
        </nav>
    </div>
    ...
    <div class="container-fluid  pt-4">
        ...
        <?php
            ...
            if(isset($_GET["ord"])&&($_GET["ord"]=="caro")){
                $sentencia = "Select * from coches where marca='tesla' order by precio desc";

            }else if(isset($_GET["ord"])&&($_GET["ord"]=="barato")){
                $sentencia = "Select * from coches where marca='tesla' order by precio asc";

            }
            //AQUI PONEMOS EL ORDEN POR CV
            else if(isset($_GET["cv"])&&($_GET["cv"]=="120")){
                $sentencia = "select * from coches where cv>120 and marca='tesla'";

            }else if(isset($_GET["ord"])&&($_GET["ord"]=="150")){
                $sentencia = "select * from coches where cv>150 and marca='tesla'";

            }else if(isset($_GET["ord"])&&($_GET["ord"]=="200")){
                $sentencia = "select * from coches where cv>200 and marca='tesla'";

            }
            //AQUI PONEMOS EL ORDEN POR KM
            else if(isset($_GET["km"])&&($_GET["km"]=="0")){
                $sentencia = "select * from coches where kilometros = 0 and marca='tesla'";

            }else if(isset($_GET["km"])&&($_GET["km"]=="20000")){
                $sentencia = "select * from coches where kilometros >=20000 and marca='tesla'";

            }else if(isset($_GET["km"])&&($_GET["km"]=="50000")){
                $sentencia = "select * from coches where kilometros >= 50000 and marca='tesla'";

            }else if(isset($_GET["km"])&&($_GET["km"]=="100000")){
                $sentencia = "select * from coches where kilometros >= 100000 and marca='tesla'";

            }
            //AQUI PONEMOS EL ORDEN POR PUERTAS 
            else if(isset($_GET["puertas"])&&($_GET["puertas"]=="2")){
                $sentencia = "select * from coches where puertas = 2 and marca='tesla'";

            }else if(isset($_GET["puertas"])&&($_GET["puertas"]=="4")){
                $sentencia = "select * from coches where puertas = 4 and marca='tesla'";
            ...
            //AQUI PONEMOS EL ORDEN POR COMBUSTIBLE
                ...
                $sentencia = "select * from coches where combustible = 'diesel' and marca='tesla'";

            }else if(isset($_GET["combustible"])&&($_GET["combustible"]=="gasolina")){
                $sentencia = "select * from coches where combustible = 'gasolina' and marca='tesla'";

            }else if(isset($_GET["combustible"])&&($_GET["combustible"]=="electrico")){
                $sentencia = "select * from coches where combustible = 'electrico' and marca='tesla'";

            }else if(isset($_GET["combustible"])&&($_GET["combustible"]=="hibrido")){
                $sentencia = "select * from coches where combustible = 'hibrido' and marca='tesla'";
            
            }else{
                $sentencia = "Select * from coches where marca='tesla'";
            }
